...
module MixinBot
  class API
    module MultiSign
      ...
      def sign_multisigs(options, access_token: nil)
        raw = build_transaction_raw(
      ...
      def unlock_multisigs(raw, access_token: nil)
        path = '/multisigs'
        payload = {
          action: 'unlock',
          raw: raw
      ...
      def verify_multi_payment(code_id, access_token: nil)
